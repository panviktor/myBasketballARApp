...
//    static let hope = BitMaskCategory(rawValue: 1 << 2)
    static let boll = BitMaskCategory(rawValue: 1 << 3)
    static let topHoop = BitMaskCategory(rawValue: 1 << 4)
    static let bottonHoop = BitMaskCategory(rawValue: 1 << 5)
}
